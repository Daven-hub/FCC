          ...
          <div className="prose prose-sm text-gray-700 mb-6 bg-gray-50 p-4 rounded-lg">
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              ...
              <li className="text-gray-700">
                Je comprends que le fait de faire une déclaration fausse ou trompeuse constitue une infraction.
              </li>
            ...
            <p className="mt-4 text-gray-700">
              <span className="font-medium">Note importante :</span> Des frais de traitement non remboursables s'appliquent et
              leur paiement ne garantit pas l'approbation de la demande.
            </p>
          </div>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            <label className="flex items-start space-x-3">
              ...
              <div className="text-sm">
                <span className="font-medium text-gray-900">Je certifie avoir lu et compris la déclaration ci-dessus.</span>
                <span className="text-red-500 ml-1">*</span>
                <p className="text-xs text-gray-500 mt-1">
                  En cochant cette case, vous confirmez l'exactitude des informations fournies et acceptez les conditions
                  générales.
                </p>
              </div>
            </label>
