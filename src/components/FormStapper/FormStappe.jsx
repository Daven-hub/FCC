...
const CombinedApplicationForm = () => {
  ...
  useEffect(() => {
    ...
    setFormData((prev) => ({
      ...
      documents: prev.documents.map((section, index) => {
        if (index === 0) {
          // Seulement la première section contient les infos personnelles
          return {
            ...section,
            nom: nom || section.nom,
    ...
    switch (stepIndex) {
      ...
      case 3: // Documents
        return formData.documents.every((section) =>
          section.corps.every((doc) => !doc.required || (doc.condition && doc.condition.response !== "oui") || doc.provided)
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const filteredResident = {
        ...
        body: {
          ...
          affiliation:
            formData.resident.body.affiliation.isOk === "oui" ? formData.resident.body.affiliation : { isOk: "non", dev: [] },
    ...
    //   formDataToSend.append("document", applicationData.documents);
    ...
    await Promise.resolve();    
      ...
      formDataToSend.append("to", "lionelfotso413@gmail.com");
      ...
      <div className="mb-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
        ...
        {docState.provided ? (
          <div className="space-y-2">
            {docState.type === "IMAGE" && docState.imageData ? (
              ...
              <div className="flex justify-between items-center bg-white p-3 rounded border border-green-100">
                <div>
                  ...
                  <p className="text-xs text-gray-400">Téléversé le: {new Date(docState.uploadDate).toLocaleString()}</p>
                </div>
                <button
                  type="button"
                  onClick={() => handleRemoveFile(sectionIndex, docIndex)}
            ...
            {uploadState?.progress > 0 && uploadState.progress < 100 && (
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div className="bg-primary h-2.5 rounded-full" style={{ width: `${uploadState.progress}%` }}></div>
          ...
          <label className="flex flex-col items-center justify-center w-full py-6 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50">
            ...
            <p className="text-xs text-gray-400 mt-1">Formats acceptés: {getAcceptedFormats()} (max 3.8MB)</p>
            <input
              type="file"
              className="hidden"
  ...
  const renderStepTitle = () => {
    ...
    return (
      <div className="mb-6 border-b pb-4">
        ...
        <p className="text-sm text-gray-600 mt-1">{getStepDescription(activeStep)}</p>
      </div>
    );
  };
  ...
  const isDocumentRequired = (docKey) => {
    const requiredDocs = ["actetenaissance", "passeport", "photo", "relevesbancairespersonnels"];

    if (docKey.toLowerCase() === "actemariage" && ["marie", "union"].includes(formData.personalInfo.etatMatrimonial)) {
      return true;
    }
      ...
      component: (
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            ...
            <div className="mt-4">
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Faites-vous la demande depuis un autre pays que votre pays de résidence actuelle ?
              </label>
              <div className="flex gap-4 mt-1">
                <label className="flex items-center">
                  <input
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            ...
            {(formData.formulaireVisa.etatMatrimonial.etat === "marie" ||
              formData.formulaireVisa.etatMatrimonial.etat === "union") && (
              <>
                <div className="mt-4">
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Avez-vous déjà été marié(e) ou en union de fait ?
                  </label>
                  <div className="flex gap-4 mt-1">
                    <label className="flex items-center">
                      <input
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Communiquez-vous en français ou en anglais ?
                </label>
                <select
                  className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Langue dans laquelle vous êtes le plus à l'aise
                </label>
                <input
                  className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Avez-vous passé une évaluation linguistique par un organisme approuvé ?
                </label>
                <div className="flex gap-4 mt-1">
                  <label className="flex items-center">
                    <input
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Passeport délivré par Taïwan avec numéro d'identification ?
                </label>
                <div className="flex gap-4 mt-1">
                  <label className="flex items-center">
                    <input
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Possédez-vous une pièce d'identité nationale ?
              </label>
              <div className="flex gap-4 mt-1">
                <label className="flex items-center">
                  <input
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Possédez-vous une carte de résident permanent des États-Unis ?
              </label>
              <div className="flex gap-4 mt-1">
                <label className="flex items-center">
                  <input
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            ...
            <div className="mt-4">
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Votre adresse domicile est-elle identique à votre adresse postale ?
              </label>
              <div className="flex gap-4 mt-1">
                <label className="flex items-center">
                  <input
                        ...
                        resident: {
                          ...
                          body: {
                            ...
                            military: {
                              isOk: "oui",
                              dev:
                                prev.resident.body.military.dev.length > 0
            ...
            {formData.resident.body.military.isOk === "oui" && (
              <div className="mt-4 space-y-4">
                ...
                <button
                  type="button"
                  onClick={() =>
                    addArrayEntry("resident", "body.military.dev", {
                      pays: "",
                      Endroit: "",
                      Province: "",
                      du: "",
                        ...
                        resident: {
                          ...
                          body: {
                            ...
                            temoin: {
                              isOk: "oui",
                              dev:
                                prev.resident.body.temoin.dev.length > 0
            ...
            {formData.resident.body.temoin.isOk === "oui" && (
              <div className="mt-4 space-y-4">
                ...
                <button
                  type="button"
                  onClick={() =>
                    addArrayEntry("resident", "body.temoin.dev", {
                      pays: "",
                      Endroit: "",
                      Province: "",
                      du: "",
                        ...
                        resident: {
                          ...
                          body: {
                            ...
                            affiliation: {
                              isOk: "oui",
                              dev:
                                prev.resident.body.affiliation.dev.length > 0
            ...
            {formData.resident.body.affiliation.isOk === "oui" && (
              <div className="mt-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleArrayChange("resident", "body.affiliation.dev", index, "Endroit", e.target.value)
                          }
                          className="w-full p-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary"
                          required
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleArrayChange("resident", "body.affiliation.dev", index, "Province", e.target.value)
                          }
                          className="w-full p-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleArrayChange("resident", "body.affiliation.dev", index, "nomOrganisation", e.target.value)
                          }
                          className="w-full p-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleArrayChange("resident", "body.affiliation.dev", index, "typeOrganisation", e.target.value)
                          }
                          className="w-full p-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary"
                        />
                      </div>
                ...
                <button
                  type="button"
                  onClick={() =>
                    addArrayEntry("resident", "body.affiliation.dev", {
                      pays: "",
                      Endroit: "",
                      Province: "",
                      du: "",
                        ...
                        resident: {
                          ...
                          body: {
                            ...
                            charges: {
                              isOk: "oui",
                              dev:
                                prev.resident.body.charges.dev.length > 0
            ...
            {formData.resident.body.charges.isOk === "oui" && (
              <div className="mt-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleArrayChange("resident", "body.charges.dev", index, "natureInfraction", e.target.value)
                          }
                          className="w-full p-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary"
                        />
                      </div>
                ...
                <button
                  type="button"
                  onClick={() =>
                    addArrayEntry("resident", "body.charges.dev", {
                      pays: "",
                      Endroit: "",
                      Province: "",
                      du: "",
                        ...
                        resident: {
                          ...
                          body: {
                            ...
                            voyages: {
                              isOk: "oui",
                              dev:
                                prev.resident.body.voyages.dev.length > 0
            ...
            {formData.resident.body.voyages.isOk === "oui" && (
              <div className="mt-4 space-y-4">
                ...
                <button
                  type="button"
                  onClick={() =>
                    addArrayEntry("resident", "body.voyages.dev", {
                      pays: "",
                      Endroit: "",
                      Province: "",
                      du: "",
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                type="button"
                onClick={() =>
                  addArrayEntry("familyInfo", "children", {
                    name: "",
                    dob: "",
                    country: "",
                    maritalStatus: "",
                ...
                {formData.familyInfo.children.map((child, index) => (
                  <div key={index} className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Accompagne le demandeur au Canada ?
                        </label>
                        <div className="flex gap-4 mt-1">
                          <label className="flex items-center">
                            <input
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                type="button"
                onClick={() =>
                  addArrayEntry("familyInfo", "siblings", {
                    name: "",
                    dob: "",
                    country: "",
                    maritalStatus: "",
    ...
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative px-[6.5%] mx-auto  ">
        ...
        <header className="text-center mb-10 md:mb-14">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">Formulaire de demande combinée</h1>
              ...
              {steps.map((step, index) => (
                <li key={index} className="flex items-center">
                  <button
                    ...
                    <span
                      className={`absolute top-full mt-2 w-32 text-center text-sm font-medium ${
                        index === activeStep
                  ...
                  {index < steps.length - 1 && (
                    <div
                      className={`hidden md:block h-0.5 w-16 mx-2 transition-all duration-500 ${
        ...
        <div className="bg-white shadow-xl rounded-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
          ...
          <div className="px-6 py-5 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">{getStepDescription(activeStep)}</p>
              </div>
          ...
          <form onSubmit={handleSubmit} className="divide-y divide-gray-200">
            <div className="px-6 py-5 sm:p-8">{steps[activeStep].component}</div>
              ...
              <div className="flex items-center justify-between">
                ...
                {activeStep < steps.length - 1 ? (
                  <button
                    ...
                    onClick={nextStep}
                    disabled={!validateCurrentStep(activeStep)}
                    className={`ml-auto inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all ${
                      validateCurrentStep(activeStep) ? "bg-primary hover:bg-primary-600" : "bg-gray-400 cursor-not-allowed"
                    }`}>
                    Suivant
                  ...
                  <button
                    ...
                    className={`ml-auto inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all ${
        ...
        <div className="mt-8 text-center">
          ...
          <p className="mt-1 text-xs text-gray-400">Vos informations sont sécurisées et ne seront pas partagées.</p>
        </div>
      </div>
    </div>
  );
