...
const CombinedApplicationForm = () => {
    ...
    documents: [
      {
        ...
        corps: [
          ...
          },
          {
            ...
            required: true,
            condition: (data) =>
              data.personalInfo.dateExpirationPasseport &&
          ...
          <div className="space-y-2">
            ...
            {uploadState?.progress > 0 && uploadState.progress < 100 && (
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div className="bg-blue-600 h-2.5 rounded-full" style={{ width: `${uploadState.progress}%` }}></div>
        ...
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Résidence dans un autre pays les 5 dernières années ?
            </label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center">
                <input
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Depuis l'âge de 18 ans ou au cours des cinq dernières années, selon la plus récente, avez-vous voyagé vers un pays
              ou territoire autre que le pays de votre nationalité ou votre pays ou territoire de résidence actuel?
            </label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center">
                <input
                      ...
                      <tr key={`desktop-${index}`}>
                        ...
                        <td className="px-4 py-2 whitespace-nowrap">
                          <input
                            ...
                            onChange={(e) =>
                              handleArrayChange("personalInfo", "detailsVoyages", index, "dateDebut", e.target.value)
                            }
                            placeholder="MM/AAAA"
                            className="w-full p-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary"
                          />
                        ...
                        <td className="px-4 py-2 whitespace-nowrap">
                          <input
                            ...
                            onChange={(e) =>
                              handleArrayChange("personalInfo", "detailsVoyages", index, "dateFin", e.target.value)
                            }
                            placeholder="MM/AAAA"
                            className="w-full p-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary"
                          />
                        ...
                        <td className="px-4 py-2 whitespace-nowrap">
                          <input
                            ...
                            onChange={(e) =>
                              handleArrayChange("personalInfo", "detailsVoyages", index, "endroit", e.target.value)
                            }
                            className="w-full p-2 border border-gray-300 rounded-md focus:ring-primary focus:border-primary"
                          />
                        </td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Pouvez-vous communiquer dans les deux langues officielles du Canada ?
              </label>
              <select
                className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Avez-vous déjà passé une évaluation linguistique ?
              </label>
              <select
                className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Votre adresse résidentielle est-elle la même que votre adresse postale ?
            </label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center">
                <input
    ...
    },
    {
      ...
      component: (
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Avez-vous été en contact étroit avec une personne atteinte de tuberculose ou avez-vous un trouble physique ou mental
              qui pourrait constituer un danger pour la santé ou la sécurité publiques ?
            </label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center">
                <input
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Avez-vous déjà eu un statut d'immigration ou de résidence temporaire au Canada qui a expiré et vous avez continué à
              rester au Canada ?
            </label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Avez-vous déjà été refusé l'entrée au Canada ou fait l'objet d'une ordonnance de renvoi ?
            </label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center">
                <input
            ...
            {formData.background.refusEntree === "oui" && (
              <div className="mt-4">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Détails du refus d'entrée ou ordonnance de renvoi
                </label>
                <textarea
                  className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  rows={3}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Avez-vous déjà fait une demande de visa, permis ou statut de résidence permanent pour le Canada ?
            </label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center">
                <input
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Avez-vous des antécédents judiciaires dans n'importe quel pays, y compris des condamnations, des accusations en
              cours ou des enquêtes criminelles ?
            </label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center">
                <input
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Avez-vous déjà servi dans l'armée, une unité de milice, une organisation de police ou de sécurité dans n'importe
              quel pays ?
            </label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Avez-vous déjà été membre ou affilié à une organisation ou association qui a utilisé la violence pour atteindre ses
              objectifs ?
            </label>
            <div className="flex gap-4 mt-1">
              <label className="flex items-center">
          ...
          <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
            ...
            <div className="prose prose-sm text-gray-700 mb-6">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  Je comprends que le fait de faire une déclaration fausse ou trompeuse constitue une infraction en vertu de la
                  Loi sur l'immigration et la protection des réfugiés.
                </li>
                <li>Je comprends que tous les renseignements fournis dans le cadre de cette demande peuvent être vérifiés.</li>
                <li>
                  Je consens à ce que les renseignements fournis soient partagés avec les organismes gouvernementaux concernés à
                  des fins de vérification.
                </li>
                <li>
                  Je comprends que le traitement de ma demande peut être retardé si je ne fournis pas tous les documents requis.
                </li>
              </ul>
              <p className="mt-4">
                Je comprends également que des frais de traitement non remboursables s'appliquent et que le paiement de ces frais
                ne garantit pas l'approbation de ma demande.
              </p>
            </div>
              ...
              <label className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <span className="font-medium text-gray-700">
                    Je certifie que j'ai lu et compris la déclaration ci-dessus et que toutes les informations fournies sont
                ...
                <div className="border-b border-gray-200 pb-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-900">{formData.personalInfo.dateNaissance}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Email</p>
                      <p className="text-sm font-medium text-gray-900">{formData.personalInfo.email}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-500">Téléphone</p>
                      <p className="text-sm font-medium text-gray-900">{formData.personalInfo.numeroTelephone}</p>
                    </div>
                    <div>
  ...
  return (
    <div className="relative px-4 sm:px-[6.5%] mx-auto py-6 md:py-8">
      ...
      {/* En-tête */}
      <div className="mb-6 md:mb-10 text-center relative z-10">
        <h1 className="text-2xl sm:text-3xl font-bold text-primary leading-snug">Formulaire de demande combinée</h1>
        <p className="mt-2 sm:mt-3 text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">
          Remplissez soigneusement toutes les sections du formulaire.
          <br className="hidden sm:block" />
          Les champs marqués d’un astérisque (*) sont obligatoires.
