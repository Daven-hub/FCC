      ...
      <View style={{ flexDirection: "column" }}>
        ...
        <View style={[styles.row, { gap: 4,padding:3, alignItems: "center",borderBottom:1,borderRight:1,borderLeft:1 }]}>
          <Text style={styles.form2_text}>
            d) Pour ce voyage, utiliserez vous un passeport délivré par le ministredes affaires étrangèresà Taiwandans lequel figure votre identificationpersonnel?
          </Text>
        </View>
        <View style={[styles.row, { gap: 4,padding:3, alignItems: "center",borderBottom:1,borderRight:1,borderLeft:1 }]}>
          <Text style={styles.form2_text}>
            e) Pour ce voyage, utilisez vous un passport israélien? 
          </Text>
        </View>
      </View>
    </View>
