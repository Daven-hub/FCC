  ...
  return (
    <View style={{ flexDirection: "column", gap: 2.5 }}>
      ...
      <View style={{ flexDirection: "column" }}>
        <View style={[styles.row, { gap: 4, alignItems: "center", borderTop: 1, borderRight: 1, borderLeft: 1 }]}>
          <View style={[styles.row, {}]}>
            ...
            <View style={{ paddingHorizontal: 3, paddingVertical: 3 }}>
              <Text style={styles.form2_text}>
                Avez vous le statut de resident permanent en règle des États-Uniset avez-vous votre certificat d'inscription au
                registre des étrangers (carte verte)?
              </Text>
            </View>
          </View>
        ...
        <View style={[styles.row]}>
          <View style={{ borderWidth: 1, width: "70%", borderColor: "black" }}>
            <View style={[styles.row, {}]}>
              <View
                style={{
                  paddingHorizontal: 5,
              ...
              <View style={{ paddingHorizontal: 5, paddingVertical: 2 }}>
                <Text style={[styles.form2_titre, { fontWeight: "bold" }]}>Numéro de la pièce</Text>
              </View>
            </View>
