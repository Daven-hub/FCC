    ...
    <View style={{ flexDirection: "column", gap: 2.5 }}>
      ...
      <View style={{ flexDirection: "column" }}>
        <View style={[styles.row, { borderWidth: 1 }]}>
          ...
          >
            <Text style={styles.form2_text}>
              *b) Pouvez vous communiquer en anglais français ou dans les deux
              langues?
            </Text>
          ...
          >
            <Text style={styles.form2_text}>
              c) Dans quelle langue êtes vous le plus à l'aise?
            </Text>
            <Text style={styles.form3_input}>{datas?.prenom}</Text>
          </View>
        </View>
        <View style={[styles.row, { gap: 4,padding:3, alignItems: "center",borderBottom:1,borderRight:1,borderLeft:1 }]}>
          <Text style={styles.form2_text}>
            d) Avez vous fait évaluer votre compétence en français ou en anglais
            par un organisme d'évaluation aprouvé?
          </Text>
        </View>
      </View>
    </View>
