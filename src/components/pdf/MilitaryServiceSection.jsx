      ...
      <View style={[styles.row, { gap: 3, alignItems: "center" }]}>
        <View
          style={{
            ...
            width: 8,
            height: 8,
            backgroundColor: value === "oui" && "black"
          }}></View>
  ...
  <View style={{ borderWidth: 1, borderColor: "black" }} wrap={false}>
    ...
    <View style={[styles.row, { paddingVertical: 6, paddingHorizontal: 12, width: "100%", flexDirection: "column", gap: 6 }]}>
      <Text style={[styles.form2_text, { lineHeight: 1.4 }]}>
        Avez vous fait partied'une armée, d'une milice, d'une unité de défence civile, d'un service de renseignement ou d'un corps
        de police(y compris le service non obligatoire et les unités de réserve et volontaires) ?
      </Text>
