...
export const HeaderT=()=>(
  <View style={[styles.row,{backgroundColor:"#80808065"}]}>
      ...
      <View style={[styles.col,{width:"26%",alignItems:"center",justifyContent:"center",borderRight:1,textAlign:"center"}]}>
        <Text style={[styles.form2_text,{fontWeight:"bold",lineHeight:1.4}]}>Nom de l'organisation</Text>
      </View>
      ...
      <View style={[styles.col,{width:"25%",alignItems:"center",justifyContent:"center",textAlign:"center",borderRight:1}]}>
        <Text style={[styles.form2_text,{fontWeight:"bold",lineHeight:1.4}]}>Province</Text>
      </View>
  ...
  <View style={{ borderWidth: 1, borderColor: "black"}}>
    <View style={[styles.row, {}]}>
      ...
      <View style={{ paddingHorizontal: 5, paddingVertical: 2 }}>
        <Text style={[styles.form2_titre, { fontWeight: "bold" }]}>Appartenance ou affiliation à des organisations</Text>
      </View>
    </View>
...
export default AffiliationServiceSection;
